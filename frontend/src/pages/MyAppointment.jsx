          ...
          <div key={index} className="grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b">
            ...
            <div className="flex flex-col gap-2 justify-end">
              {item.isCompleted ? (
                ...
                <>
                  <button 
                    onClick={() => handleReschedule(item.docId)}
                    className="text-sm text-center sm:min-w-48 py-2 border rounded text-stone-500 hover:bg-primary hover:text-white transition-all duration-300"
                  >
