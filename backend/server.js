...
const allowedOrigins = [
    'http://localhost:5173',
    'http://localhost:5174',
    'https://medisync-ruby.vercel.app',
    'https://medisync-rvfg.vercel.app'
];
...
const corsOptions = {
    ...
    allowedHeaders: ['Content-Type', 'Authorization', 'Accept', 'atoken', 'aToken', 'dToken', 'dtoken', 'uToken', 'utoken', 'token', 'Token'],
    credentials: true
};
